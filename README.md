...
```
cd existing_repo
git remote add origin https://depot.dinf.usherbrooke.ca/dinf/projets/e23/eq09-musique/notable.git
git branch -M main
...
- [ ] [Set up project integrations](https://depot.dinf.usherbrooke.ca/dinf/projets/e23/eq09-musique/notable/-/settings/integrations)
