...
template <typename T>
std::vector<std::complex<T>> FastFourierTransform::CombineToComplexVect(T* reals, T* imags, int len)
{
    ...
    template <typename T>
    std::vector<std::complex<float>> FastFourierTransform::DoFFT(std::vector<T>& data)
    {
    ...
    // REALLY NOT IDEAL
    template <typename T>
    std::vector<std::complex<float>> FastFourierTransform::DoFFT(const std::vector<std::complex<T>>& data, bool)
    {
...
*/
    ...
    template <typename T>
    std::vector<std::complex<float>> FastFourierTransform::DoFFTRealTime(std::vector<T>& data)
    {
    ...
    template <typename T>
    void FastFourierTransform::DoFFT(std::vector<T>& data)
    {
        //...
    }
